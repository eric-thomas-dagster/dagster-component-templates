...
|---|---|---|
| `allowed_failures` | `int` | Number of groups allowed to fail |
| `blocking` | `bool` | Whether this check is blocking (fails the pipeline) |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `group_by` | `str` | — | Column to group by for analysis |
| `name` | `str` | — | Custom name for this check |
| `severity` | `CheckSeverity` | — | Severity level for the check |
