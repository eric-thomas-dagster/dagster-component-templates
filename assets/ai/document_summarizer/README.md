...
| Field | Type | Default | Description |
|---|---|---|---|
| `input_column` | `Union[str, int]` | `"text"` | Column name containing document text to summarize |
| `output_column` | `Union[str, int]` | `"summary"` | Column name for generated summaries |
