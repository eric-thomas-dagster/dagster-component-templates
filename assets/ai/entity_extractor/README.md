...
| Field | Type | Default | Description |
|---|---|---|---|
| `input_column` | `Union[str, int]` | `"text"` | Column name containing text to extract entities from |
| `output_column` | `Union[str, int]` | `"entities"` | Column name for the extracted entities (used when output_format='structured'). |
