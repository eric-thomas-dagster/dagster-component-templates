...
class EntityExtractorComponent(Component, Model, Resolvable):
    ...
    upstream_asset_key: str = Field(description="Upstream asset key providing a DataFrame with text to extract entities from")
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "entity_extractor"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        def entity_extractor_asset(context: AssetExecutionContext, upstream: pd.DataFrame) -> pd.DataFrame:
...
Return empty array [] if no entities found."""
        ...
        _schema_checks = build_column_schema_change_checks(assets=[entity_extractor_asset])
