...
| Field | Type | Default | Description |
|---|---|---|---|
| `count_column` | `Union[str, int]` | `"face_count"` | Column to write detected face count |
| `boxes_column` | `Union[str, int]` | — | If set, write list of bounding box dicts to this column |
| `landmarks_column` | `Union[str, int]` | — | If set, write facial landmarks to this column |
