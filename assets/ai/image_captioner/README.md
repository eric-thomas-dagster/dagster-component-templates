...
| `image_path_column` | `Union[str, int]` | Column containing local image file paths or URLs |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"caption"` | Column to write generated caption text |
