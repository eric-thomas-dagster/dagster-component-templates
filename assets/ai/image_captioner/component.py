...
class ImageCaptionerComponent(Component, Model, Resolvable):
    ...
    image_path_column: Union[str, int] = Field(description="Column containing local image file paths or URLs")
    output_column: Union[str, int] = Field(default="caption", description="Column to write generated caption text")
    ...
    def build_defs(self, load_context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "image_captioner"  # component directory name
        _kind_map = {
