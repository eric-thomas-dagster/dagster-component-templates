...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"detected_objects"` | Column for list of {label, confidence, bbox} dicts per row |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `count_column` | `Union[str, int]` | `"object_count"` | Column for detected object count |
