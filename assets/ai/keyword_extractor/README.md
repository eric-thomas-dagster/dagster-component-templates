...
| `input_column` | `Union[str, int]` | Column containing text to extract keywords from |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"keywords"` | Column to write list of keyword strings |
