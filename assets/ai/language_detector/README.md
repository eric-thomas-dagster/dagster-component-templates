...
| `input_column` | `Union[str, int]` | Column containing text to detect language from |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"language"` | Column to write ISO 639-1 language code e.g. 'en', 'es' |
...
| `confidence_column` | `Union[str, int]` | — | If set, write confidence score to this column |
