...
| Field | Type | Default | Description |
|---|---|---|---|
| `input_column` | `Union[str, int]` | `"text"` | Column name containing the initial input text for the chain |
| `output_column` | `Union[str, int]` | `"chain_result"` | Column name to store chain result (JSON string) |
