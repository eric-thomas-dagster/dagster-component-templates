...
| Field | Type | Default | Description |
|---|---|---|---|
| `input_column` | `Union[str, int]` | `"llm_response"` | Column name containing LLM output text to parse |
| `output_column` | `Union[str, int]` | `"parsed_output"` | Column name for parsed results |
