...
| `output_score_column` | `Union[str, int]` | `"rerank_score"` | Column name for reranking scores |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `query_column` | `Union[str, int]` | `"query"` | Column name containing search queries |
| `text_column` | `Union[str, int]` | `"text"` | Column name containing document text to rerank |
| `score_column` | `Union[str, int]` | `"score"` | Column name for original scores (optional) |
