...
class RerankerComponent(Component, Model, Resolvable):
 ...
 (approximate, as of 2024)
        ...
        _comp_name = "reranker"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        _schema_checks = build_column_schema_change_checks(assets=[reranker_asset])


        return Definitions(assets=[reranker_asset], asset_checks=list(_schema_checks))
