...
| Field | Type | Default | Description |
|---|---|---|---|
| `input_column` | `Union[str, int]` | `"text"` | Column name containing text to moderate |
...
| `flag_column` | `Union[str, int]` | `"flagged"` | Column name for overall flag (true if any category exceeds threshold) |
