...
| `text_column` | `Union[str, int]` | Column containing text to model topics from |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"topic_id"` | Column to write integer topic ID |
| `topic_label_column` | `Union[str, int]` | `"topic_keywords"` | Column to write top keywords string for the assigned topic |
...
| `method` | `str` | `"lda"` | Topic modeling method: lda or nmf |
| `max_features` | `int` | `1000` | Vocabulary size for TF-IDF vectorizer |
| `top_words_per_topic` | `int` | `5` | Number of top keywords to include in topic label |
