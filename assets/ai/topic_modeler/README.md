...
| `text_column` | `str` | Column containing text to model topics from |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `str` | `"topic_id"` | Column to write integer topic ID |
| `topic_label_column` | `str` | `"topic_keywords"` | Column to write top keywords string for the assigned topic |
