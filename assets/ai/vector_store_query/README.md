...
| `embedding_column` | `str` | `"embedding"` | Column name containing query embeddings in the upstream DataFrame |
| `query_text_column` | `str` | — | Column with query text to copy into output rows (helps downstream rerankers correlate query+document) |
