...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"vision_analysis"` | Column name for analysis results |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `image_column` | `Union[str, int]` | `"image_url"` | Column name containing image URLs or file paths |
