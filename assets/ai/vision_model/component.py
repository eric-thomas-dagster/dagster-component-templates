...
class VisionModelComponent(Component, Model, Resolvable):
    ...
    upstream_asset_key: str = Field(
        description="Upstream asset key providing a DataFrame with image references"
    )
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "vision_model"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        def vision_model_asset(context: AssetExecutionContext, upstream: pd.DataFrame) -> pd.DataFrame:
        ...
        _schema_checks = build_column_schema_change_checks(assets=[vision_model_asset])


        return Definitions(assets=[vision_model_asset], asset_checks=list(_schema_checks))
