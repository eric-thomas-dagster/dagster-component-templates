...
Ingest database data from Airtable (tables, records, views) using dlt's Airtable source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from Airtable.
...
**Available Resources:**
Tables, Records, Attachments, Linked Records
...
See `schema.json` for complete list of authentication and configuration parameters specific to Airtable.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to Airtable.
...
- `dlt[airtable]` - Installs dlt with Airtable source
