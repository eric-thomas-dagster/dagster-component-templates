...
class ABTestAnalysisComponent(Component, Model, Resolvable):
    ...
    upstream_asset_key: str = Field(
        description="Upstream asset key providing a DataFrame with experiment data"
    )
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "ab_test_analysis"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        def ab_test_analysis_asset(context: AssetExecutionContext, upstream: pd.DataFrame) -> pd.DataFrame:
                ...
                return Output(
                    ...
                    metadata={
                        **metadata,
                        ...
                        "preview": MetadataValue.md(result_df.to_markdown())
                    }
                )
            else:
        ...
        _schema_checks = build_column_schema_change_checks(assets=[ab_test_analysis_asset])


        return Definitions(assets=[ab_test_analysis_asset], asset_checks=list(_schema_checks))
