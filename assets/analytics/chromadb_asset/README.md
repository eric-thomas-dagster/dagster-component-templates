...
| `id_column` | `Union[str, int]` | Primary key column. Values are cast to strings and used as ChromaDB document IDs. |
| `text_column` | `Union[str, int]` | Column containing the document text to embed. |
