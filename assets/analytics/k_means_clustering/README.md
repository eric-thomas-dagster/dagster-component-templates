...
| `feature_columns` | `List[Union[str, int]]` | List of column names to use as clustering features |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"cluster"` | Column name to store cluster assignment |
