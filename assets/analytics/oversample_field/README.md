...
| `target_column` | `Union[str, int]` | Binary or categorical target column to balance |
...
| `feature_columns` | `List[Union[str, int]]` | — | Feature columns to use for resampling (None = all columns except target) |
