...
class PriorityScorerComponent(Component, Model, Resolvable):
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "priority_scorer"  # component directory name
        _kind_map = {
...
"""
        ...
        _schema_checks = build_column_schema_change_checks(assets=[priority_scorer_asset])


        return Definitions(assets=[priority_scorer_asset], asset_checks=list(_schema_checks))
