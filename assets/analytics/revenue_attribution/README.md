...
| Field | Type | Description |
|---|---|---|
| `asset_name` | `str` | Name of the revenue attribution output asset |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `marketing_data_asset_key` | `str` | — | Marketing data asset with spend and campaigns (automatically set via lineage) |
| `revenue_data_asset_key` | `str` | — | Revenue data asset (Stripe charges/subscriptions) (automatically set via lineage) |
| `customer_360_asset` | `str` | — | Customer 360 data for enhanced attribution (optional) |
| `attribution_model` | `Literal['first_touch', 'last_touch', 'linear', 'time_decay']` | `"last_touch"` | Attribution model to use |
| `attribution_window_days` | `int` | `30` | Days to attribute revenue after campaign interaction |
| `join_key` | `str` | `"email"` | Key to join marketing and revenue data (email, customer_id) |
