...
class SimulationSamplingComponent(Component, Model, Resolvable):
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "simulation_sampling"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        _schema_checks = build_column_schema_change_checks(assets=[simulation_sampling_asset])


        return Definitions(assets=[simulation_sampling_asset], asset_checks=list(_schema_checks))
