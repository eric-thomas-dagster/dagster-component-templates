...
| `platform` | `Literal['zendesk', 'freshdesk', 'intercom']` | Source support platform to standardize |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `filter_status` | `str` | — | Filter by ticket status (comma-separated) |
| `filter_priority` | `str` | — | Filter by priority level (comma-separated) |
| `filter_date_from` | `str` | — | Filter tickets from this date (YYYY-MM-DD) |
| `filter_date_to` | `str` | — | Filter tickets to this date (YYYY-MM-DD) |
...
| `ticket_id_field` | `str` | — | Field name for ticket ID (auto-detected if not provided) |
| `status_field` | `str` | — | Field name for status (auto-detected if not provided) |
