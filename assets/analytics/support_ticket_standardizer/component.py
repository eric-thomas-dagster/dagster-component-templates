...
class SupportTicketStandardizerComponent(Component, Model, Resolvable):
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "support_ticket_standardizer"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        _schema_checks = build_column_schema_change_checks(assets=[support_ticket_standardizer_asset])


        return Definitions(assets=[support_ticket_standardizer_asset], asset_checks=list(_schema_checks))
