...
class TestOfMeansComponent(Component, Model, Resolvable):
    ...
    value_column: Union[str, int] = Field(description="Numeric column to compare across groups.")
    group_column: Union[str, int] = Field(description="Binary group column (control vs treatment, A vs B, etc).")
