...
| `text_column` | `Union[str, int]` | Column name containing the raw text to process |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | — | Output column name (defaults to overwriting text_column) |
