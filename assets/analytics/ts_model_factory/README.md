...
| `value_column` | `Union[str, int]` | Column containing numeric time series values |
| `group_column` | `Union[str, int]` | Column identifying each group/entity (e.g. product_id, store_id) |
