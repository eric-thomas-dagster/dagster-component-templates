...
Ingest development data from GitHub (repos, pull requests, issues, commits) using dlt's GitHub source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from GitHub.
...
**Available Resources:**
Repositories, Pull Requests, Issues, Commits, Contributors
...
See `schema.json` for complete list of authentication and configuration parameters specific to GitHub.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to GitHub.
...
- `dlt[github]` - Installs dlt with GitHub source
