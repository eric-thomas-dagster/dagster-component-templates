...
Ingest web analytics data from Google Analytics 4 using dlt's GA4 source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from Google Analytics 4.
...
**Available Resources:**
Events, Sessions, Users, Conversions, Traffic Sources
...
See `schema.json` for complete list of authentication and configuration parameters specific to Google Analytics 4.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to Google Analytics 4.
...
- `dlt[google_analytics]` - Installs dlt with Google Analytics 4 source
