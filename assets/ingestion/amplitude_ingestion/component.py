...
class AmplitudeIngestionComponent(Component, Model, Resolvable):
    ...
    api_key: str = Field(description='Amplitude project API key, used as the HTTP Basic auth username.')

    secret_key: str = Field(description='Amplitude project secret key, used as the HTTP Basic auth password.')
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        def amplitude_ingestion_asset(context: AssetExecutionContext):
            ...
            _base = "https://analytics.eu.amplitude.com" if self.eu_residency else "https://amplitude.com"
            config = {
                "client": {
                    "base_url": _base,
                    "auth": {"type": "http_basic", "username": self.api_key, "password": self.secret_key},
                },
                "resources": [],
            }
            _map = {
