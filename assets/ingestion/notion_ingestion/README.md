...
Ingest [Notion](https://www.notion.so) database content using [dlt](https://dlthub.com)'s verified `notion` source.
...
- **Integration access**: the integration must be invited to each database in the Notion UI.
