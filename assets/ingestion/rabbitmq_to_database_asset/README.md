...
| Field | Type | Default | Description |
|---|---|---|---|
| `amqp_url` | `str` | — | AMQP URL (amqp://user:pass@host/vhost). Set this OR amqp_url_env_var. |
| `amqp_url_env_var` | `str` | — | Env var with AMQP URL. Set this OR amqp_url. |
| `database_url` | `str` | — | SQLAlchemy database URL. Set this OR database_url_env_var. |
| `schema_name` | `str` | — | Destination schema name |
| `prefetch_count` | `int` | `100` | AMQP prefetch count |
