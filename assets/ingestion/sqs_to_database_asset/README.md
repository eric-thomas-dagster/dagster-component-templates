...
| `queue_url_env_var` | `str` | Env var with SQS queue URL |
...
| `batch_size` | `int` | `10` | SQS ReceiveMessage batch size (1-10) |
...
| `visibility_timeout` | `int` | `60` | SQS visibility timeout in seconds |
