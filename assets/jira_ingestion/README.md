...
Ingest project management data from Jira (issues, projects, sprints) using dlt's Jira source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from Jira.
...
**Available Resources:**
Issues, Projects, Sprints, Workflows, Comments
...
See `schema.json` for complete list of authentication and configuration parameters specific to Jira.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to Jira.
...
- `dlt[jira]` - Installs dlt with Jira source
