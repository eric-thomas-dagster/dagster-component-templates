...
Ingest web analytics data from Matomo (formerly Piwik) using dlt's Matomo source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from Matomo.
...
**Available Resources:**
Visits, Actions, Goals, E-commerce, Custom Dimensions
...
See `schema.json` for complete list of authentication and configuration parameters specific to Matomo.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to Matomo.
...
- `dlt[matomo]` - Installs dlt with Matomo source
