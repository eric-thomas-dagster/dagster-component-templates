...
Ingest workspace data from Notion (pages, databases, blocks) using dlt's Notion source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from Notion.
...
See `schema.json` for complete list of authentication and configuration parameters specific to Notion.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to Notion.
...
- `dlt[notion]` - Installs dlt with Notion source
...
- [dlt Notion Source](https://dlthub.com/docs/dlt-ecosystem/verified-sources/notion)
