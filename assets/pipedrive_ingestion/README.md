...
Ingest sales CRM data from Pipedrive (deals, contacts, organizations) using dlt's Pipedrive source.

## Overview

This component uses [dlt (data load tool)](https://dlthub.com) to extract data from Pipedrive.
...
**Available Resources:**
Deals, Persons, Organizations, Activities, Pipelines
...
See `schema.json` for complete list of authentication and configuration parameters specific to Pipedrive.
...
Refer to `schema.json` and the [dlt documentation](https://dlthub.com/docs) for authentication requirements specific to Pipedrive.
...
- `dlt[pipedrive]` - Installs dlt with Pipedrive source
