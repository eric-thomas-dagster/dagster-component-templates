...
| `partition_key_column` | `Union[str, int]` | DataFrame column that maps to PartitionKey on each entity |
| `row_key_column` | `Union[str, int]` | DataFrame column that maps to RowKey on each entity (unique within partition) |
