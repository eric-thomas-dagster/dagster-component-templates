...
|---|---|---|---|
| `asset_name` | `str` | `"lineage_to_file"` | Output sink asset name |
...
| `catalog_url` | `str` | `"data/exports/dagster_lineage.json"` | Catalog endpoint base URL. |
| `api_token_env` | `str` | — | Env var holding the API token / OAuth bearer. |
