...
|---|---|---|---|
| `asset_name` | `str` | `"lineage_to_openlineage"` | Output sink asset name |
...
| `catalog_url` | `str` | `"https://marquez.example.com"` | Catalog endpoint base URL. |
| `api_token_env` | `str` | `"OPENLINEAGE_API_TOKEN"` | Env var holding the API token / OAuth bearer. |
