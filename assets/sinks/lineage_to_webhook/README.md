...
|---|---|---|---|
| `asset_name` | `str` | `"lineage_to_webhook"` | Output sink asset name |
...
| `catalog_url` | `str` | `"https://example.com/lineage-webhook"` | Catalog endpoint base URL. |
| `api_token_env` | `str` | `"LINEAGE_WEBHOOK_TOKEN"` | Env var holding the API token / OAuth bearer. |
