...
class ChromadbReaderComponent(Component, Model, Resolvable):
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "chromadb_reader"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        _schema_checks = build_column_schema_change_checks(assets=[chromadb_reader_asset])


        return Definitions(assets=[chromadb_reader_asset], asset_checks=list(_schema_checks))
