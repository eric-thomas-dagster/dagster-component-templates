...
| `database_type` | `str` | Source database dialect: postgres / mysql / mssql / oracle / db2 / db2_iseries / snowflake / redshift. Use 'db2' for Db2 LUW / Cloud / Warehouse (catalog at SYSCAT.*); use 'db2_iseries' for Db2 for i / AS/400 / IBM i (ca… _(full docs in schema.json + component README)_ |
