...
group_name=group_name,
        ...
        _schema_checks = build_column_schema_change_checks(assets=[mongodb_reader_asset])


        return Definitions(assets=[mongodb_reader_asset], asset_checks=list(_schema_checks))
