...
class Neo4jReaderComponent(Component, Model, Resolvable):
    ...
    def build_defs(self, context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "neo4j_reader"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        _schema_checks = build_column_schema_change_checks(assets=[neo4j_reader_asset])


        return Definitions(assets=[neo4j_reader_asset], asset_checks=list(_schema_checks))
