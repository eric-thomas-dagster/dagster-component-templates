...
| `ignore_index` | `bool` | `true` | Reset index after explode so the result has a clean integer index. |
| `drop_nulls` | `bool` | `false` | Drop rows where the exploded value is null/NaN. |
