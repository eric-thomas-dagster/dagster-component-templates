...
| `index_column` | `Union[str, int]` | Column to use for row labels |
| `pivot_column` | `Union[str, int]` | Column whose unique values become new column headers |
| `value_column` | `Union[str, int]` | Values to aggregate in the pivot table |
