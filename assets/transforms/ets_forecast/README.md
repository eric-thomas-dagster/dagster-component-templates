...
| `value_column` | `Union[str, int]` | Column name containing the numeric values to forecast |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_mode` | `str` | `"forecast"` | Output mode: 'forecast' or 'append' |
...
| `trend` | `str` | `"add"` | Trend component: None, 'add', or 'mul' |
| `seasonal` | `str` | `"add"` | Seasonal component: None, 'add', or 'mul' |
| `seasonal_periods` | `int` | `12` | Number of seasonal periods (e.g. 12 for monthly, 7 for weekly) |
