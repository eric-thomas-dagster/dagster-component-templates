...
Filter rows from a DataFrame using a condition expression.
"""
...
class FilterComponent(Component, Model, Resolvable):
    """Filter rows from a DataFrame using a query condition."""
    ...
    negate: bool = Field(
        default=False,
        description="If True, keep rows that do NOT match the condition",
    )
    ...
    def get_description(cls) -> str:
        return "Filter rows from a DataFrame using a query condition."
    ...
    def build_defs(self, load_context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "filter"  # component directory name
        _kind_map = {
...
group_name=group_name,
            description=FilterComponent.get_description(),
