...
| `lookup_key_column` | `Union[str, int]` | Column in lookup table to match against |
| `lookup_value_column` | `Union[str, int]` | Column in lookup table with replacement values |
| `target_column` | `Union[str, int]` | Column in main DataFrame to look up |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | — | Output column name (defaults to overwriting target_column) |
