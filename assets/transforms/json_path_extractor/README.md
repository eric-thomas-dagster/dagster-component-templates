...
| `extractions` | `Dict[str, str]` | Mapping of new_column_name to JSONPath expression, e.g. {'user_id': '$.user.id', 'tags': '$.meta.tags[*]'} |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `source_column` | `Union[str, int]` | — | If set, apply JSONPath to this column; if not set, apply to whole row as dict. |
