...
| `column` | `Union[str, int]` | Column containing PDF file paths or bytes |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_column` | `Union[str, int]` | `"pdf_text"` | Column to write extracted text to. |
...
| `pages` | `str` | — | Comma-separated page numbers or ranges like '1,3,5-10'. Default is all pages. |
| `include_page_numbers` | `bool` | `false` | Prefix each page's text with '[Page N]'. |
