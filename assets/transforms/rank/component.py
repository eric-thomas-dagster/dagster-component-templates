...
class RankComponent(Component, Model, Resolvable):
    ...
    def build_defs(self, load_context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "rank"  # component directory name
        _kind_map = {
        ...
        # Build-time lineage: rank column derived from the sort column
        if not column_lineage and hasattr(self, 'sort_column') and self.sort_column:
            _rank_col = self.rank_column if hasattr(self, 'rank_column') and self.rank_column else "rank"
            column_lineage = {_rank_col: [self.sort_column]}
