...
class SortComponent(Component, Model, Resolvable):
    """Sort a DataFrame by one or more columns."""

    asset_name: str = Field(description="Output Dagster asset name")
    upstream_asset_key: str = Field(description="Upstream asset key providing a DataFrame")
    by: List[Union[str, int]] = Field(description="Columns to sort by")
    ascending: bool = Field(
        default=True,
        description="Sort ascending (True) or descending (False) for all columns",
    )
    ascending_per_column: Optional[List[bool]] = Field(
        default=None,
        description=(
            "Per-column ascending flags as a list matching the length of 'by'. "
            "When set, overrides the 'ascending' field."
        ),
    )
    ...
    def get_description(cls) -> str:
        return "Sort a DataFrame by one or more columns."
    ...
    def build_defs(self, load_context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "sort"  # component directory name
        _kind_map = {
