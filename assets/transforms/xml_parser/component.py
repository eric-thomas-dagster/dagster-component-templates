...
@dataclass
class XmlParser(Component, Model, Resolvable):
    """Parse XML content in a column into separate fields using XPath expressions."""
    ...
    def get_description(cls) -> str:
        return "Parse XML content in a column into separate fields using XPath expressions."
    ...
    def build_defs(self, load_context: ComponentLoadContext) -> Definitions:
        ...
        _comp_name = "xml_parser"  # component directory name
        _kind_map = {
...
group_name=group_name,
        ...
        def _asset(context: AssetExecutionContext, upstream: pd.DataFrame) -> pd.DataFrame:
            ...
            for col_name, xpath in xpath_expressions.items():
                df[col_name] = df[xml_column].apply(lambda x: extract_xpath(x, xpath, ns))
