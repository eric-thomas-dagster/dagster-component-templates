...
# Document Text Extractor README
cat > /Users/ericthomas/dagster_components/dagster-component-templates/assets/document_text_extractor/README.md << 'EOF'
...
echo "Created Document Text Extractor README"
