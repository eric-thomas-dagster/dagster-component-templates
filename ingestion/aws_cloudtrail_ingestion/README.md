...
| `lookback_hours` | `int` | `24` | How far back to fetch events |
| `event_name_filter` | `str` | — | Filter by EventName (e.g. 'ConsoleLogin') |
| `username_filter` | `str` | — | Filter by Username |
| `aws_profile` | `str` | — | Boto3 profile name (overrides env) |
