...
|---|---|---|---|
| `limit` | `int` | `200` | Per-page (max 9999) |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `token_env` | `str` | `"SLACK_AUDIT_TOKEN"` | Env var holding Slack Enterprise audit-log token |
| `lookback_hours` | `int` | `24` | How far back |
| `action_filter` | `str` | — | Filter by action (e.g. 'user_login_failed') |
