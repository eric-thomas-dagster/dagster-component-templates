...
|---|---|---|
| `databricks_config_path` | `str` | Path to databricks.yml bundle configuration file (relative to project root) |
| `workspace_host` | `str` | Databricks workspace URL |
| `workspace_token` | `str` | Databricks personal access token |

### Catalog metadata

| Field | Type | Default | Description |
|---|---|---|---|
| `group_name` | `str` | `"databricks_bundle"` | Group name for all generated assets |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `asset_key_prefix` | `str` | — | Optional prefix for all asset keys generated from bundle tasks |
