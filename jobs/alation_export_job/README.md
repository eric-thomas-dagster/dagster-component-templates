...
| `catalog_url` | `str` | `"https://alation.example.com"` | Alation base URL. /integration/v2/lineage/ is appended. |
| `api_token_env` | `str` | `"ALATION_API_TOKEN"` | Env var holding the Alation API token (sent as `TOKEN` header). |
