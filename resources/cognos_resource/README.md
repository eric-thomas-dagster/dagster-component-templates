...
|---|---|---|
| `base_url_env_var` | `str` | Env var with Cognos Analytics base URL (no /api path). |
| `username_env_var` | `str` | Env var with Cognos username. |
| `password_env_var` | `str` | Env var with Cognos password. |
| `namespace_env_var` | `str` | Env var with the Cognos security namespace (e.g. LDAP, CognosEx). |
