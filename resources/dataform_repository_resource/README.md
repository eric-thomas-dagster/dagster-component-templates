...
|---|---|---|
| `location` | `str` | Dataform location (e.g. 'us-central1', 'europe-west1'). |
| `repository_id` | `str` | Dataform repository id within the project/location. |
| `environment` | `str` | Dataform release environment (a Dataform concept — typically 'production', 'staging', etc.). |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"dataform_repo"` | Key under which the resource is exposed in Definitions.resources. |
...
| `project_id` | `str` | — | GCP project. Default: project from credentials. |
