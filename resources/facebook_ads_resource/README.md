...
|---|---|---|
| `app_id_env_var` | `str` | Env var holding Facebook App ID |
| `app_secret_env_var` | `str` | Env var holding Facebook App Secret |
| `access_token_env_var` | `str` | Env var holding long-lived access token |
| `ad_account_id` | `str` | Facebook Ad Account ID e.g. 'act_123456789' |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"facebook_ads_resource"` | Key used to register this resource. Other components reference it via resource_key. |
