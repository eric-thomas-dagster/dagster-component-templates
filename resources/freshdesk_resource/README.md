...
|---|---|---|
| `domain` | `str` | Freshdesk domain e.g. 'mycompany.freshdesk.com' |
| `api_key_env_var` | `str` | Env var holding Freshdesk API key |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"freshdesk_resource"` | Key used to register this resource. Other components reference it via resource_key. |
