...
|---|---|---|
| `server_url` | `str` | Jira server URL e.g. https://mycompany.atlassian.net |
| `username` | `str` | Jira username (email) |
| `api_token_env_var` | `str` | Env var holding Jira API token |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"jira_resource"` | Key used to register this resource. Other components reference it via resource_key. |
