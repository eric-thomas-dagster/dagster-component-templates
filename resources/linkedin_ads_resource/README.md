...
|---|---|---|
| `access_token_env_var` | `str` | Env var holding LinkedIn OAuth2 access token |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"linkedin_ads_resource"` | Key used to register this resource. Other components reference it via resource_key. |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `ad_account_id` | `str` | — | LinkedIn Ad Account ID |
