...
|---|---|---|
| `project_id` | `str` | Mixpanel project ID (required for /import). |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"mixpanel"` | — |
| `base_url` | `str` | `"https://api.mixpanel.com"` | — |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `project_token_env_var` | `str` | `"MIXPANEL_PROJECT_TOKEN"` | — |
| `service_account_username_env_var` | `str` | `"MIXPANEL_SERVICE_ACCOUNT_USERNAME"` | — |
| `service_account_secret_env_var` | `str` | `"MIXPANEL_SERVICE_ACCOUNT_SECRET"` | — |
