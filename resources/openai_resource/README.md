...
|---|---|---|---|
| `resource_key` | `str` | `"openai_resource"` | Key used to register this resource. Other components reference it via resource_key. |
| `api_key_env_var` | `str` | `"OPENAI_API_KEY"` | Environment variable holding the OpenAI API key |
