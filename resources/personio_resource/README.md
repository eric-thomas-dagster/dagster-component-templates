...
|---|---|---|
| `client_id_env_var` | `str` | Env var holding Personio client ID |
| `client_secret_env_var` | `str` | Env var holding Personio client secret |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"personio_resource"` | Key used to register this resource. Other components reference it via resource_key. |
