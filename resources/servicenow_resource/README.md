...
|---|---|---|
| `instance_env_var` | `str` | Env var with the ServiceNow instance subdomain (e.g. 'mycompany' or 'dev123456'). Do NOT include 'https://' or '.service-now.com' — just the subdomain. |

### Connection

| Field | Type | Default | Description |
|---|---|---|---|
| `resource_key` | `str` | `"servicenow_resource"` | Resource key. Other components reference it via this name. |
