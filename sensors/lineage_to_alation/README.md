...
Sensor that exports the Dagster asset lineage graph to **alation**.
...
| Var | Value |
|---|---|
| `ALATION_API_TOKEN` | API token / OAuth bearer for alation |
...
attributes:
  demo_mode: true
  demo_export_path: data/exports/lineage_to_alation.json
```
