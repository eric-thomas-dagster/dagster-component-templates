...
Sensor that exports the Dagster asset lineage graph to Collibra Data Intelligence Platform.
...
class LineageToCollibraComponent(dg.Component, dg.Model, dg.Resolvable):
    """Lineage → Collibra — sensor that pushes the Dagster asset lineage graph to collibra.
    ...
    sensor_name: str = Field(default="lineage_to_collibra_sync")
    ...
    demo_export_path: Optional[str] = Field(
        default="data/exports/lineage_to_collibra.json",
    ...
    def build_defs(self, context: dg.ComponentLoadContext) -> dg.Definitions:
        ...
        @dg.sensor(
            ...
            description=f"Sync the Dagster asset lineage graph to collibra. Only pushes when the graph changes.",
        )
        def lineage_sensor(context: dg.SensorEvaluationContext):
            ...
            if demo_mode and export_path:
                ...
                context.log.info(f"Pushed lineage to collibra")
