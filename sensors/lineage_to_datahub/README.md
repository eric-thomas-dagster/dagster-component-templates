...
Sensor that exports the Dagster asset lineage graph to **datahub**.
...
| Var | Value |
|---|---|
| `DATAHUB_API_TOKEN` | API token / OAuth bearer for datahub |
...
attributes:
  demo_mode: true
  demo_export_path: data/exports/lineage_to_datahub.json
```
