...
Sensor that exports the Dagster asset lineage graph to **openlineage**.
...
| Var | Value |
|---|---|
| `OPENLINEAGE_API_TOKEN` | API token / OAuth bearer for openlineage |
...
attributes:
  demo_mode: true
  demo_export_path: data/exports/lineage_to_openlineage.json
```
