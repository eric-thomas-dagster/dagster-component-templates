...
| Field | Type | Default | Description |
|---|---|---|---|
| `source_category` | `str` | — | Override X-Sumo-Category |
| `source_name` | `str` | — | Override X-Sumo-Name |
| `source_host` | `str` | — | Override X-Sumo-Host |

### Other

| Field | Type | Default | Description |
|---|---|---|---|
| `collector_url_env` | `str` | `"SUMO_HTTP_URL"` | Env var with the full HTTP Source URL |
